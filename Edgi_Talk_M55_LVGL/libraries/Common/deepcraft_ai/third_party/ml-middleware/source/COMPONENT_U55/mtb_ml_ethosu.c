...
cy_rslt_t mtb_ml_ethosu_init(struct ethosu_driver *ethosu_drv, uint32_t priority)
{
    ...
    printf("[AI][ethosu] A: mtb_ml_ethosu_init enter\r\n");
    ...
    printf("[AI][ethosu] B: IRQ enabled, calling Cy_SysEnableU55\r\n");

    /* Must enable peripheral before initializing driver*/
    Cy_SysEnableU55(true);
    printf("[AI][ethosu] C: Cy_SysEnableU55 done, calling ethosu_init\r\n");
    ...
    printf("[AI][ethosu] D: ethosu_init done\r\n");
    ...
    printf("[AI][ethosu] E: mtb_ml_ethosu_init done\r\n");
